...
**DOWNLOAD THE COMPLETE CODEBASE AS A ZIP FILE AND DOWNLOAD THE PRE-TRAINED MODEL FROM THE LINK [HERE](https://txst-my.sharepoint.com/:u:/g/personal/sii25_txstate_edu/IQA8AFR5l99FSJrkI2hpblDjAZthl68vgmCE2UUIGCfWgHE). MOVE THE DOWNLOADED MODEL TO THE `/checkpoint/` DIRECTORY. THE DATASET IS ALREADY INCLUDED IN THIS REPOSITORY.**
